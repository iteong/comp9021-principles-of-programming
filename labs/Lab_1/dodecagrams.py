...
# Without the following statement, the left end of the horizontal edge of the
# green dodecagram, from which the drawing starts, would be at the centre of the screen
