...
#
# Writtten by Ivan Teong and Eric Martin for COMP9021
...
if len(sys.argv) != 4:
    print('Provide exactly three comman xd line arguments')
    sys.exit()
try:
...
rotated_encoded_list = []
for j in encoding_as_list:
    x = (j + rotation) % max_element
    rotated_encoded_list.append(x)
    rotated_encoded_list.sort()
